...
#define CONFIG_FILE "/home/fukan/zdx/Sift/servers.config"
...
#define RM_REPLICATED_MEMORY_SIZE       (2ull << 30)
// Total memory used
...
#define KV_CACHE_SIZE                   (KV_SIZE*3 / 10)
// Size of index table
